...
void WelcomeBanner() {
    ...
    std::cout << "[8] DEVICE MNGER SCAN" << std::endl;
    std::cout << "[9] MEMORY DIAG" << std::endl;
    std::cout << "[10] DXDIAG" << std::endl;
...
std::cout << "[8]: Scans all drives on device manager, telling which ones arent working properly. " << std::endl;
std::cout << "[9]: Schedules a memory diagnostic on your next reboot. " << std::endl;
std::cout << "[10]: Scans your dxdiag for gpu/driver issues. " << std::endl;
